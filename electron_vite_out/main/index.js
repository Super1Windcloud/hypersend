...
async function DoubaoServicesPro(question, onData) {
  const client = new OpenAI({
    apiKey: process.env.DouBao,
    baseURL: "https://ark.cn-beijing.volces.com/api/v3/",
    dangerouslyAllowBrowser: true
...
function createAppLLMServices(app2) {
  app2.post("/llm/qwen_plus", async (request, reply) => {
    ...
    try {
      writeLog("请求LLM接口");
      let result = await aliQwenPlus(question, (chunk) => {
  ...
  app2.post("/llm/qwen2_5", async (request, reply) => {
    reply.raw.setHeader("Content-Type", "text/plain; charset=utf-8");
    reply.raw.setHeader("Transfer-Encoding", "chunked");
    reply.raw.flushHeaders();
    const { question } = request.body;
  ...
  app2.post("/llm/qwen_max", async (request, reply) => {
    reply.raw.setHeader("Content-Type", "text/plain; charset=utf-8");
    reply.raw.setHeader("Transfer-Encoding", "chunked");
    reply.raw.flushHeaders();
    const { question } = request.body;
  ...
  app2.post("/llm/qwen_qwq32b", async (request, reply) => {
    reply.raw.setHeader("Content-Type", "text/plain; charset=utf-8");
    reply.raw.setHeader("Transfer-Encoding", "chunked");
    reply.raw.flushHeaders();
    const { question } = request.body;
    ...
    try {
      writeLog("请求LLM接口");
      let result = await aliQwenQwQ32B(question, (chunk) => {
        reply.raw.write(chunk);
        process.stdout.write(chunk);
      });
      reply.raw.end();
  ...
  app2.post("/llm/siliconflow_qwen", async (request, reply) => {
    reply.raw.setHeader("Content-Type", "text/plain; charset=utf-8");
    reply.raw.setHeader("Transfer-Encoding", "chunked");
    reply.raw.flushHeaders();
    const { question } = request.body;
    ...
    try {
      writeLog("请求LLM接口");
      let result = await SiliconflowServices(question, (chunk) => {
        reply.raw.write(chunk);
        process.stdout.write(chunk);
      });
      reply.raw.end();
  ...
  app2.post("/llm/deepseek", async (request, reply) => {
    reply.raw.setHeader("Content-Type", "text/plain; charset=utf-8");
    reply.raw.setHeader("Transfer-Encoding", "chunked");
    reply.raw.flushHeaders();
    const { question } = request.body;
    ...
    try {
      writeLog("请求LLM接口");
      let result = await DeepSeekApiServices(question, (chunk) => {
        reply.raw.write(chunk);
        process.stdout.write(chunk);
      });
      reply.raw.end();
  ...
  app2.post("/llm/kimi", async (request, reply) => {
    reply.raw.setHeader("Content-Type", "text/plain; charset=utf-8");
    reply.raw.setHeader("Transfer-Encoding", "chunked");
    reply.raw.flushHeaders();
    const { question } = request.body;
    ...
    try {
      writeLog("请求LLM接口");
      let result = await KimiServices(question, (chunk) => {
        reply.raw.write(chunk);
        process.stdout.write(chunk);
      });
      reply.raw.end();
  ...
  app2.post("/llm/doubao_lite", async (request, reply) => {
    reply.raw.setHeader("Content-Type", "text/plain; charset=utf-8");
    reply.raw.setHeader("Transfer-Encoding", "chunked");
    reply.raw.flushHeaders();
    const { question } = request.body;
    ...
    try {
      writeLog("请求LLM接口");
      let result = await DoubaoLiteServices(question, (chunk) => {
        reply.raw.write(chunk);
        process.stdout.write(chunk);
      });
      reply.raw.end();
  ...
  app2.post("/llm/doubao_pro", async (request, reply) => {
    reply.raw.setHeader("Content-Type", "text/plain; charset=utf-8");
    reply.raw.setHeader("Transfer-Encoding", "chunked");
    reply.raw.flushHeaders();
    const { question } = request.body;
    ...
    try {
      writeLog("请求LLM接口");
      let result = await DoubaoServicesPro(question, (chunk) => {
        reply.raw.write(chunk);
        process.stdout.write(chunk);
      });
      reply.raw.end();
  ...
  app2.post("/llm/doubao_deepseek", async (request, reply) => {
    reply.raw.setHeader("Content-Type", "text/plain; charset=utf-8");
    reply.raw.setHeader("Transfer-Encoding", "chunked");
    reply.raw.flushHeaders();
    const { question } = request.body;
    ...
    try {
      writeLog("请求LLM接口");
      let result = await DoubaoServicesDeepSeek(question, (chunk) => {
        reply.raw.write(chunk);
        process.stdout.write(chunk);
      });
      reply.raw.end();
  ...
  app2.post("/llm/random", async (request, reply) => {
    reply.raw.setHeader("Content-Type", "text/plain; charset=utf-8");
    reply.raw.setHeader("Transfer-Encoding", "chunked");
    reply.raw.flushHeaders();
    const { question } = request.body;
  ...
  app2.post("/llm/codegeex", async (request, reply) => {
    reply.raw.setHeader("Content-Type", "text/plain; charset=utf-8");
    reply.raw.setHeader("Transfer-Encoding", "chunked");
    reply.raw.flushHeaders();
    const { question } = request.body;
